...
library(tidyr)
library(ggplot2)
setwd("~/Desktop/2nd Semester/5243 ADS/Spring2020-Project4-spring2020-project4-group3/data/")
...
mat1= als1$q
mat2=t(as.matrix(als1$p))%*%as.matrix(als1$q)
mat2.2 =t(as.matrix(als1$q))%*%as.matrix(als1$p)

write.csv(mat1, file = "../output/A3_q_dim10.csv")
write.csv(mat2.2, file = "../output/A3_r_dim10.csv")
```
